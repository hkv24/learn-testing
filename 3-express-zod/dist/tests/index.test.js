...
(0, globals_1.describe)("POST method to /sum route", () => {
    (0, globals_1.it)("should return the sum of two numbers", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        (0, globals_1.expect)(res.body).toBe(7);
    }));
    (0, globals_1.it)("should return the sum of two numbers", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield (0, supertest_1.default)(index_1.app).post("/sum").send({
            a: ['4'],
        ...
        (0, globals_1.expect)(res.body.message).toBe("Invalid input");
    }));
});
(0, globals_1.describe)('GET method to /sum route', () => {
    (0, globals_1.it)("should return the sum of two numbers", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, globals_1.it)('should return 411', () => __awaiter(void 0, void 0, void 0, function* () {
